...
#the mail. The program creates a Python dictionary that maps the sender's mail address to a count of the 
...
prolificCount=None
for commit,counter in count.items():
    if prolificCommitter is None or counter > prolificCount:
       prolificCommitter=commit
       prolificCount=counter
        
print(prolificCommitter,prolificCount)
